...
ieee80211_wme_initglobalparams(struct ieee80211com *ic)
{
    ...
    for (i = 0; i < WME_NUM_AC; i++) {
        switch (i) {
        case WME_AC_BK:
            adf_os_mem_copy(ic->phyParamForAC[WME_AC_BK], phyParamForAC_BK,
                    sizeof(phyParamForAC_BK));
            adf_os_mem_copy(ic->bssPhyParamForAC[WME_AC_BK], phyParamForAC_BK,
                    sizeof(phyParamForAC_BK));
            break;
        case WME_AC_VI:
            adf_os_mem_copy(ic->phyParamForAC[WME_AC_VI], phyParamForAC_VI,
                    sizeof(phyParamForAC_VI));
            adf_os_mem_copy(ic->bssPhyParamForAC[WME_AC_VI], bssPhyParamForAC_VI,
                    sizeof(bssPhyParamForAC_VI));
            break;
        case WME_AC_VO:
            adf_os_mem_copy(ic->phyParamForAC[WME_AC_VO], phyParamForAC_VO,
                    sizeof(phyParamForAC_VO));
            adf_os_mem_copy(ic->bssPhyParamForAC[WME_AC_VO], bssPhyParamForAC_VO,
                    sizeof(bssPhyParamForAC_VO));
            break;
        case WME_AC_BE:
        default:
            adf_os_mem_copy(ic->phyParamForAC[WME_AC_BE], phyParamForAC_BE,
                    sizeof(phyParamForAC_BE));
            adf_os_mem_copy(ic->bssPhyParamForAC[WME_AC_BE], bssPhyParamForAC_BE,
