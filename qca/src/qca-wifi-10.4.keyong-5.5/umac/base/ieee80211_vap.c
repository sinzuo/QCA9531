...
#define DEFAULT_WATERMARK_THRESHOLD 50
    ...
    adf_os_spinlock_init(&vap->iv_mu_cap_lock);
    vap->mu_cap_timer_period = MU_TIMER_PERIOD;
    vap->mu_cap_war = 0;   /* default is disable state */
...
ieee80211_vap_detach(struct ieee80211vap *vap)
{
    ...
    adf_os_spinlock_destroy(&vap->iv_mu_cap_lock);
