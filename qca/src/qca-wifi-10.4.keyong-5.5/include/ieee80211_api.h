...
/**
 * Get the vap name and update the
 * corresponding dscp_tid_map values
 * to firmware.
...
/**
 *  configure desired bssid through iwpriv
 *
 *  @param vaphandle     : handle to the vap.
 *  @param extra         : value of the parameter.
 */
void set_desired_bssid(wlan_if_t vaphandle, unsigned char* extra);
