...
struct htt_rx_callbacks {
   ...
   u_int32_t  (*rx_ind_fw_rx_desc_bytes_get)(rx_handle_t rxh, adf_nbuf_t rx_ind_msg);
   adf_nbuf_t (*rx_netbuf_peek)(rx_handle_t rxh);
   adf_nbuf_t (*rx_netbuf_pop)(rx_handle_t rxh);
   u_int32_t  (*rx_buf_size)(rx_handle_t rxh);
   adf_nbuf_t (*rx_debug)(rx_handle_t rxh, adf_nbuf_t rx_ind_msg, adf_nbuf_t msdu, int *npackets, int msdu_done);
   ...
   void       (*ath_add_vow_extstats)(rx_handle_t rxh, adf_nbuf_t msdu);
   void       (*ath_arp_debug)(rx_handle_t rxh, adf_nbuf_t msdu);
};
...
struct ar_rx_desc_ops {
    ...
    u_int32_t (*check_desc_mgmt_type)(adf_nbuf_t head_msdu);
    u_int32_t (*check_desc_ctrl_type)(adf_nbuf_t head_msdu);
    u_int32_t (*check_desc_phy_data_type)(adf_nbuf_t head_msdu, uint8_t *rx_phy_data_filter);
    u_int32_t (*get_l3_header_padding)(adf_nbuf_t head_msdu);
    u_int32_t (*amsdu_pop)(ar_handle_t arh,
                ...
                u_int32_t* npackets);
    adf_nbuf_t (*restitch_mpdu_from_msdus)(ar_handle_t arh,
                 adf_nbuf_t head_msdu,
                 struct ieee80211_rx_status *rx_status,
                 unsigned clone_not_reqd);
    void      (*get_vowext_stats)(adf_nbuf_t msdu,
