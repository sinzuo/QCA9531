        ...
        adf_nbuf_t msdu)
{
    ...
    if (tcp_proto)
    {
        ...
        lro_info = (lro_info_t *)adf_nbuf_get_cb(msdu);
...
static u_int32_t _qca9984_rx_desc_check_desc_phy_data_type(adf_nbuf_t head_msdu, uint8_t *rx_phy_data_filter)
{
...
static u_int32_t _qca9984_rx_desc_get_l3_header_padding(adf_nbuf_t head_msdu)
{
