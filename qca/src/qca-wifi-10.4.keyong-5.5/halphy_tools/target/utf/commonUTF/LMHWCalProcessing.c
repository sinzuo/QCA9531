...
extern A_STATUS tcmd_setup_channel(wlan_tcmd_dev_t *dev, A_UINT32 freq, A_UINT32 wlanMode, A_UINT32 bandwidth, A_UINT32 freq2);
...
//            LMHWCal_time_stamp[0] = A_RTC_WLAN_REG_READ(MAC_PCU_WBTIMER_1_ADDRESS);
       //    A_PRINTF_ONCE("gDPDCalDone=%d, g_currentLM->chainMask=%d\n", gDPDCalDone, g_currentLM->chainMask);
            ...
            if (A_OK != tcmd_setup_channel(dev, g_currentLM->freq, g_currentLM->wlanMode, bandwidth, g_currentLM->freq2))
