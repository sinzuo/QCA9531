...
#ifdef ATH_AHB
extern int ol_ath_ahb_configure(hif_softc_t hif_sc, struct net_device *dev, hif_handle_t *hif_hdl);
extern int ahb_wait_for_target(hif_softc_t hif_sc);
extern void ahb_txrx_ce_list_init(hif_softc_t hif_sc);
extern void ahb_irq_enable(hif_softc_t hif_sc);
extern int ahb_init_radio(hif_softc_t hif_sc);
#else
#define ol_ath_ahb_configure(sc, dev, hif) (-1)
#define ahb_wait_for_target(sc) (-1)
#define ahb_txrx_ce_list_init(sc)
#define ahb_irq_enable(sc)
#define ahb_init_radio(sc) (-1)
#endif
