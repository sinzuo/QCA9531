...
static u_int32_t _ar900b_rx_desc_check_desc_phy_data_type(adf_nbuf_t head_msdu, uint8_t *rx_phy_data_filter)
{
...
static u_int32_t _ar900b_rx_desc_get_l3_header_padding(adf_nbuf_t head_msdu)
{
