...
#define HIF_TYPE_AR900B 9
#define HIF_TYPE_QCA9984 10
#define HIF_TYPE_IPQ4019 11
#define HIF_TYPE_QCA9888 12
...
int HIFDiagReadSram(HIF_DEVICE *hif_device, unsigned int sram_base, void *dst,  size_t len);
int HIFDiagReadSoc_ipq4019(HIF_DEVICE *hif_device, A_UINT32 address, A_UINT8 *data, int nbytes);
    /*
...
int hif_state_check(struct ath_hif_pci_softc *sc);
#endif
