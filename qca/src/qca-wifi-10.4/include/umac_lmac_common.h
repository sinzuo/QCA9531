        ...
        if (ic->ic_is_macreq_enabled(ic)) { \
            ...
            u_int8_t hw_bssid1 = ( hwbssid[ATH_VAP_ID_INDEX] &   \
                                 ( ATH_VAP_ID_MASK >> ATH_VAP_ID_SHIFT ) )   \
                                   << ATH_VAP_ID_SHIFT ;        \
            u_int8_t hw_bssid2 = ( hwbssid[ATH_VAP_ID_INDEX+1] &  \
                                 ( ATH_VAP_ID_MASK << ( OCTET - ATH_VAP_ID_SHIFT ) ) )  \
                                   >> ( OCTET - ATH_VAP_ID_SHIFT ) ;     \
            u_int8_t temp_hw_bssid = ( ( hw_bssid1 | hw_bssid2 ) & ATH_VAP_ID_MASK )\
                                       >> ( OCTET -width ) ;    \
            u_int8_t bssid1 = ( bssid[ATH_VAP_ID_INDEX] & \
                              ( ATH_VAP_ID_MASK >> ATH_VAP_ID_SHIFT ) ) \
                                << ATH_VAP_ID_SHIFT ;     \
            u_int8_t bssid2 = ( bssid[ATH_VAP_ID_INDEX+1] & \
                              ( ATH_VAP_ID_MASK << ( OCTET - ATH_VAP_ID_SHIFT ) ) ) \
                               >> ( OCTET - ATH_VAP_ID_SHIFT ) ;      \
            u_int8_t temp_bssid = ( ( bssid1 | bssid2   ) & ATH_VAP_ID_MASK ) \
                                   >> ( OCTET - width ) ;    \
        ...
        if (ic->ic_is_macreq_enabled(ic)) { \
            ...
            if(id) {     \
                ...
                u_int8_t hw_bssid2 = ( hwbssid[ATH_VAP_ID_INDEX+1] & \
                                     ( ATH_VAP_ID_MASK << ( OCTET-ATH_VAP_ID_SHIFT ) ) ) \
                                      >> ( OCTET - ATH_VAP_ID_SHIFT ) ;        \
                u_int8_t temp_hw_bssid = ( ( hw_bssid1 | hw_bssid2 ) +  \
                                          ( id << ( OCTET - width ) ) ) &  \
                                          ATH_VAP_ID_MASK ;          \
