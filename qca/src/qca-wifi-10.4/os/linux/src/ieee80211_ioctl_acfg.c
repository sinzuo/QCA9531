...
static const a_uint8_t *phymode_strings[] = {
    ...
    [ACFG_PHYMODE_11AC_VHT160]  = (a_uint8_t *)"11ACVHT160" ,
    [ACFG_PHYMODE_11AC_VHT80_80]  = (a_uint8_t *)"11ACVHT80_80" ,
...
int
acfg_add_client(void *ctx, a_uint16_t cmdid,
                a_uint8_t *buffer, a_int32_t Length)
{
    int status = -EINVAL;
    struct net_device *dev = (struct net_device *) ctx;
...
int
acfg_delete_client(void *ctx, a_uint16_t cmdid,
                a_uint8_t *buffer, a_int32_t Length)
{
    int status = -EINVAL;
    struct net_device *dev = (struct net_device *) ctx;
...
int
acfg_authorize_client(void *ctx, a_uint16_t cmdid,
                a_uint8_t *buffer, a_int32_t Length)
{
    struct net_device *dev = (struct net_device *) ctx;
	osif_dev *osifp = ath_netdev_priv(dev);
...
int
acfg_del_key(void *ctx, a_uint16_t cmdid,
             a_uint8_t  *buffer, a_int32_t Length)
{
    struct net_device *dev = (struct net_device *) ctx;
	osif_dev *osifp = ath_netdev_priv(dev);
...
int
acfg_set_key(void *ctx, a_uint16_t cmdid,
            a_uint8_t  *buffer, a_int32_t Length)
{
    struct net_device *dev = (struct net_device *) ctx;
	osif_dev *osifp = ath_netdev_priv(dev);
    ...
    acfg_set_key_t    *ptr;
    int status = 0;
	a_uint8_t cipher = IEEE80211_CIPHER_NONE;
...
int
acfg_set_mu_whtlist(void *ctx, a_uint16_t cmdid,
            a_uint8_t  *buffer, a_int32_t Length)
{
      struct net_device *dev = (struct net_device *) ctx;
      osif_dev *osifp = ath_netdev_priv(dev);
    ...
    status = ol_net80211_set_mu_whtlist(vap, ptr->macaddr, ptr->tidmask);

    return status;
}

int acfg_add_ie(void *ctx, a_uint16_t cmdid,
               a_uint8_t  *buffer, a_int32_t Length)
{
    int status = -EINVAL;
    struct net_device *dev = (struct net_device *) ctx;
    ...
    a_uint8_t* tmp_buf = ptr->buf;
    a_int32_t i;
    printk("%s: %d ==dump buffer==ptr->frmtype=0x%x, ptr->buflen=0x%x \n",__FUNCTION__,__LINE__,ptr->frmtype, ptr->buflen);
...
int acfg_set_vap_vendor_param(void *ctx, a_uint16_t cmdid,
               a_uint8_t  *buffer, a_int32_t Length)
{
    int status = 0;
    struct net_device *dev = (struct net_device *) ctx;
...
int acfg_get_vap_vendor_param(void *ctx, a_uint16_t cmdid,
               a_uint8_t  *buffer, a_int32_t Length)
{
    int status = 0;
    struct net_device *dev = (struct net_device *) ctx;
...
int
acfg_set_chanswitch(void *ctx, a_uint16_t cmdid,
                    a_uint8_t *buffer, a_int32_t Length)
{
    struct net_device *dev = (struct net_device *) ctx;
    ...
    return ieee80211_ucfg_set_chanswitch(vap, req->data.chan, IEEE80211_RADAR_11HCOUNT, 0);
}
...
int 
acfg_mon_enable_filter(void *ctx, a_uint16_t cmdid,
               a_uint8_t *buffer, a_int32_t Length)
{
    struct net_device *dev = (struct net_device *) ctx;
    acfg_os_req_t *req;
    ...
    return (wlan_set_monitor_filter(ic, filter_type));
}

int
acfg_mon_listmac(void *ctx, a_uint16_t cmdid,
               a_uint8_t *buffer, a_int32_t Length)
{
   struct net_device *dev = (struct net_device *) ctx;
   osif_dev *osifp = ath_netdev_priv(dev);
...
int
acfg_mon_addmac(void *ctx, a_uint16_t cmdid,
               a_uint8_t *buffer, a_int32_t Length)
{
   struct net_device *dev = (struct net_device *) ctx;
   acfg_macaddr_t    *ptr;
...
int
acfg_mon_delmac(void *ctx, a_uint16_t cmdid,
               a_uint8_t *buffer, a_int32_t Length)
{
   struct net_device *dev = (struct net_device *) ctx;
   acfg_macaddr_t    *ptr;
 ...
 */
int
acfg_acl_addmac_secondary(void *ctx, a_uint16_t cmdid,
               a_uint8_t *buffer, a_int32_t length)
{
    struct net_device *dev = (struct net_device *) ctx;
    acfg_macaddr_t *ptr;
...
int
acfg_acl_getmac_secondary(void *ctx, a_uint16_t cmdid,
               a_uint8_t *buffer, a_int32_t length)
{
    struct net_device *dev = (struct net_device *) ctx;
    acfg_macacl_t *ptr;
...
int
acfg_acl_delmac_secondary(void *ctx, a_uint16_t cmdid,
               a_uint8_t *buffer, a_int32_t length)
{
    struct net_device *dev = (struct net_device *) ctx;
    acfg_macaddr_t *ptr;
...
static int
acfg_set_ratemask(void *ctx, a_uint16_t cmdid,
             a_uint8_t *buffer, a_int32_t Length)
{
    struct net_device *dev = (struct net_device *) ctx;
    osif_dev  *osifp = ath_netdev_priv(dev);
...
int
acfg_assoc_sta_info(void *ctx, a_uint16_t cmdid,
             a_uint8_t *buffer, a_int32_t Length)
{
    struct net_device *dev = (struct net_device *) ctx;
    osif_dev  *osifp = ath_netdev_priv(dev);
 ...
 */
static int
acfg_get_beacon_supported_rates(void *ctx, a_uint16_t cmdid,
             a_uint8_t *buffer, a_int32_t Length)
{
    struct net_device *dev = (struct net_device *) ctx; 
    osif_dev  *osifp = ath_netdev_priv(dev);
                            ...
                            int process_pid, int rel_lock, acfg_offchan_stat_t *stat)
{
    ...
    if (rel_lock) {
      adf_os_mutex_release(ic->ic_adf_dev, acfg_nl->sem_lock);
    }
}
                           ...
                           u_int8_t *bssid, ieee80211_xmit_status *ts)
{
    ...
    adf_os_atomic_dec(&acfg_nl->num_cmpl_pending);

    if (adf_os_atomic_read(&acfg_nl->num_cmpl_pending) == 0) {
    ...
    ic = (struct ieee80211com *)vap->iv_ic;
        ...
        for(i = 0; i < num_frames; i++) {
            ...
            if (acfg_frame->type == ACFG_PKT_TYPE_MGMT) {
                rate = whal_mcs_to_kbps(acfg_frame->preamble, acfg_frame->mcs, 1, 0);
                if (! ol_rate_is_valid_basic(vap, rate)) {
                    IEEE80211_DPRINTF(vap, IEEE80211_MSG_ANY,
                                        "%s(): Invalid rate!\n", __func__);
                    acfg_resp->status[i].status = ACFG_PKT_STATUS_BAD;
                    goto next;
            ...
            adf_os_atomic_inc(&acfg_nl->num_cmpl_pending);
            adf_os_spin_lock_bh(&acfg_nl->offchan_lock);
            adf_nbuf_queue_add(&acfg_nl->offchan_list, wbuf);
            adf_os_spin_unlock_bh(&acfg_nl->offchan_lock);
            /* offchan TX stats */
            if (acfg_frame->type == ACFG_PKT_TYPE_MGMT) {
        ...
        next:
            ...
            acfg_frame = (struct acfg_offchan_tx_hdr *)((a_uint8_t*)(acfg_frame + 1) + acfg_frame->length);
        }
...
void acfg_offchan_tx_send(struct ieee80211vap *vap, acfg_netlink_pvt_t *acfg_nl)
{
    ...
    adf_os_spin_lock_bh(&acfg_nl->offchan_lock);
    if (!adf_nbuf_is_queue_empty(&acfg_nl->offchan_list)) {
        wbuf = adf_nbuf_queue_remove(&(acfg_nl->offchan_list));
        adf_os_spin_unlock_bh(&acfg_nl->offchan_lock);
        if (wbuf) {
            /* send the pkt */
...
void acfg_offchan_tx_drain(acfg_netlink_pvt_t *acfg_nl)
{
    ...
    if (adf_os_atomic_read(&acfg_nl->num_cmpl_pending)) {
        adf_os_spin_lock_bh(&acfg_nl->offchan_lock);
        while(!adf_nbuf_is_queue_empty(&acfg_nl->offchan_list)) {
            wbuf = adf_nbuf_queue_remove(&(acfg_nl->offchan_list));
            if (wbuf) {
                adf_os_atomic_dec(&acfg_nl->num_cmpl_pending);
                wbuf_free(wbuf);
...
static struct ieee80211vap *ieee80211_acfg_find_vap(a_uint8_t *vap_name, int *invalid_vap)
{
    struct ieee80211com *ic;
...
void acfg_process_msg(wbuf_t msg)
{
    ...
    if (adf_os_atomic_read(&(vap->init_in_progress)) || osifp->is_stop_event_pending) {
        IEEE80211_DPRINTF(vap, IEEE80211_MSG_ANY,
    ...
    if(adf_os_mutex_acquire_intr(ic->ic_adf_dev, acfg_nl->sem_lock)){
    ...
    adf_os_atomic_init(&acfg_nl->num_cmpl_pending);
    acfg_nl->vap = vap;
...
int acfg_attach(struct ieee80211com *ic)
{
    ...
    if (ic->ic_acfg_handle == NULL) {
        ...
        acfg_nl->sem_lock = (adf_os_mutex_t *) (OS_MALLOC(
                    ic->ic_osdev,
                    sizeof(adf_os_mutex_t),
                    GFP_KERNEL));
        if (acfg_nl->sem_lock == NULL) {
            printk("%s: Unable to allocate memory \n", __func__);
            return -ENOMEM;
        }
        adf_os_init_mutex(acfg_nl->sem_lock);
        adf_os_spinlock_init(&acfg_nl->offchan_lock);
        adf_nbuf_queue_init(&acfg_nl->offchan_list);
        OS_INIT_TIMER(ic->ic_osdev, &acfg_nl->offchan_timer, acfg_offchan_timer, ic);
...
void acfg_detach(struct ieee80211com *ic)
{
    ...
    if (acfg_nl) {
        adf_os_spinlock_destroy(&acfg_nl->offchan_lock);
...
*/
static a_uint32_t
acfg_diag_get_status(a_int64_t sec)
{
    a_uint32_t status = 0;
...
acfg_diag_get_sta_stats(void *ptr, wlan_node_t node)
{
    ...
    a_uint16_t mode;
    wlan_chan_t chan;
    a_uint32_t warn_threshold, err_threshold;
...
int acfg_diag_attach(struct ieee80211com *ic)
{
    ...
    if (ic->ic_diag_handle == NULL) {
        ...
        OS_INIT_TIMER(ic->ic_osdev, &diag->diag_timer, acfg_diag_timer, ic);
