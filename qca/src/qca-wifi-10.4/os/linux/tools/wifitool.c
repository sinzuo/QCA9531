...
send_bcnrpt(const char *ifname, int argc, char *argv[])
{
    ...
    if (argc < 14) {
        ...
        if ((argc == 14) ||(!wifitool_mac_aton(argv[14], bcnrpt->bssid, 6))){
            bcnrpt->bssid[0] = 0xff;
            bcnrpt->bssid[1] = 0xff;
            bcnrpt->bssid[2] = 0xff;
            bcnrpt->bssid[3] = 0xff;
...
static void atf_dump_debug(const char *ifname, int argc, char *argv[])
{
    ...
    for (i = 0; i < size; i++) {
        printf("%8ld %8d %8d %8d %8d %8d %8d %8d %8d %8d %8d %8d %8d %8d %8d %8d %8d %8d %8d\n",
...
static void tr069_chan_history(const char *ifname, int argc, char *argv[])
{
    ...
    u_int8_t act_idx=0;
    struct tm tm;
    struct timespec *ts = NULL, nowtime = {0}, tstamp;
...
get_assoc_time(const char *ifname, int argc, char *argv[])
{
    ...
    int s=0, len=0;
    u_int8_t *cp;
    struct timespec now_ts = {0}, assoc_ts, delta_ts;
...
static void tr069_gettimestamp(const char *ifname, int argc, char *argv[])
{
    ...
    struct tm tm;
    struct timespec nowtime = {0}, tstamp;
