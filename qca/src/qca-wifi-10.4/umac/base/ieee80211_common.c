...
#endif
    OS_INIT_TIMER(ic->ic_osdev, &(ic->ic_noise_stats), ieee80211_noise_stats_update, (void *) (ic));
...
ieee80211_ifdetach(struct ieee80211com *ic)
{
    ...
    adf_mempool_destroy(ic->ic_adf_dev, ic->mempool_net80211_scan_entry);
#if ATH_SUPPORT_DFS
