...
typedef struct ieee80211com {
    ...
    adf_mempool_t mempool_net80211_scan_entry; /* Memory pool for scan entries */
    bool                          ic_initialized;
...
#define CONSIDER_OBSS_LONG_SLOT_DEFAULT 0
    ...
    adf_os_atomic_t               ic_ast_reserve_event;
...
#if ATH_SUPPORT_FIPS
    adf_os_atomic_t ic_fips_event; /* Set when wmi_fips_event occurs*/
...
#define ATH_HMMC_CNT_MAX 8
...
#ifdef ATH_SUPPORT_DFS
    void          *ic_dfs;
    adf_os_work_t                       dfs_cac_timer_start_work;
#if ATH_SUPPORT_DFS && ATH_SUPPORT_STA_DFS
    void          *ic_dfs_flags;
#endif
    ...
    struct ieee80211vap                 *other_ic_stavap;    /* other ic STA VAP */
#endif
...
#define     IEEE80211_MESH_PEER_TIMEOUT_CNT  60
#endif
...
#define PROC_FNAME_SIZE 20
    ...
    adf_os_atomic_t            init_in_progress;
...
#define MAX_PEER_NUM           1200   /*max client numbers per ssid*/
#define MU_CAP_STATE_CHG       1
#define MU_CAP_STATE_NOR       0
#define MU_TIMER_RUNNING       1
#define MU_TIMER_STOP          0
#define MU_TIMER_PERIOD        10    /* 10*1000 seconds */
    u_int8_t                   mu_cap_client_num;    /*Without dedicated clients */
    u_int8_t                   mu_cap_dedicate_client_num;    /* Only dedicated clients*/
    u_int8_t                   mu_cap_client_addr[MAX_PEER_NUM][IEEE80211_ADDR_LEN]; /*Mu-cap client address associated*/
    u_int8_t                   mu_cap_client_flag[MAX_PEER_NUM]; /* 1: Mu-cap client; 0: dedicated client*/
    adf_os_spinlock_t          iv_mu_cap_lock;
    os_timer_t                 iv_mu_cap_timer;
    u_int8_t                   iv_mu_cap_state_switch;  /*1: mu-cap client num 0-->1;0: no switch*/
    u_int8_t                   iv_mu_timer_state;     /*1: Timer running; 0: Timer stop */
    u_int16_t                  mu_cap_timer_period;   /*default is 10 seconds, it is configurable */
    u_int8_t                   mu_cap_war;            /*1: Enable, 0: Disable */
    u_int8_t                   mu_cap_post_war;       /* Assistance for WAR enabel/disable during running time */
