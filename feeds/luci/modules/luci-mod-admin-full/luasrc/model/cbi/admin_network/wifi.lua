...
if hwtype == "qcawifi" then
    ...
    --            tp.rmempty = true
        ...
        tp:value("1", "1 dB (1mW)")
        tp:value("8", "8 dB (6mW)")
        tp:value("10", "10 dB (10mW)")
        tp:value("14", "14 dB (25mW)")
        tp:value("18", "18 dB (63mW)")
        tp:value("20", "20 dB (100mW)")
	tp:value("21", "21 dB (125mW)")
        tp:value("23", "23 dB (200mW)")
        tp:value("25", "25 dB (300mW)")
        tp:value("26", "26 dB (400mW)")
        tp:value("27", "27 dB (500mW)")
        tp:value("28", "28 dB (630mW)")
        tp:value("29", "29 dB (800mW)")
        tp:value("30", "30 dB (1000mW)")




	mode = s:taboption("advanced", ListValue, "hwmode", translate("Mode"))
	--mode:value("11bng", translate("auto"))
	if hw_modes.b then mode:value("11b", "802.11b") end
	if hw_modes.g then mode:value("11g", "802.11g") end
	if hw_modes.a then mode:value("11a", "802.11a") end
	...
	htmode:value("HT80", "80MHz")
        ...
        rate = s:taboption("advanced", ListValue, "lowrate", translate("Lower Rate"))
        rate:value(" ","auto")
	rate:value("2","1M")                                                  
        rate:value("4","2M")                                                  
        rate:value("6","3M")                                                       
...
if hwtype == "qcawifi" then
	...
	s:taboption("advanced", Flag, "wmm", translate("WMM Mode"))
        ...
        s:taboption("advanced",Flag,"portal",translate("portal认证"))
        s:taboption("advanced",Value,"maxsta",translate("Connection Limit"))
        -------------------------------support 11ac------------------------------
	if hw_modes.ac then
